export default function FootAddress() {
  return (
    <aside className="flex flex-col w-full items-center justify-start border-l border-neutral-800 h-full text-white">
      ...
      <div className="flex flex-col justify-center overflow-hidden rounded">
          <iframe className="rounded-lg" width="480" height="220" id="gmap_canvas" src="https://maps.google.com/maps?q=rio%20de%20janeiro&t=&z=5&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no"></iframe>
